    ...
    <div>
      ...
      <div class="mx-4 mb-4 -mt-20">
        <form class="max-w-4xl mx-auto bg-white [box-shadow:0_2px_13px_-6px_rgba(0,0,0,0.4)] sm:p-8 p-4 rounded-md">
          ...
          <div class="mt-8">
            <button type="button" class="py-2.5 px-5 text-sm font-medium tracking-wider rounded-sm cursor-pointer text-white bg-blue-600 hover:bg-blue-700 focus:outline-0">
              Sign up
            </button>
          </div>
        </form>
